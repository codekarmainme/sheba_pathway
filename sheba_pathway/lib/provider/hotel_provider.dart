...
class HotelProvider extends ChangeNotifier {
  List<HotelModels> _fetchedHotels = [];
  List<HotelModels> get fetchedHotels => _fetchedHotels;
  ...
  Future<void> fetchHotels(double lat, double lng, int radius) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data.containsKey('elements')) {
          ...
          _fetchedHotels = hotels;
          notifyListeners(); // Notify listeners about the data update
          print("Fetched hotels: $_fetchedHotels");
        } else {
